      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-3">
            {/* Search Icon */}
            <Link href="/products" className="hidden md:block p-2 transition-colors hover:opacity-70" style={{ color: '#c9a84c' }}>
            ...
            >
              ...
              {totalItems > 0 && (
                <span
                  ...
                  style={{ background: '#c9a84c', color: '#1c0f08', borderRadius: '50%' }}
                >
            ...
            {/* Mobile Search Icon */}
            <Link href="/products" className="md:hidden p-2 transition-colors hover:opacity-70" style={{ color: '#c9a84c' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                <circle cx="11" cy="11" r="8" />
                <path d="m21 21-4.35-4.35" />
              </svg>
