...
export default function ProductDetailPage() {
    ...
    return (
      <div style={{ background: '#f8f4ef', minHeight: '100vh', paddingTop: 120 }} className="flex items-center justify-center">
        <div className="text-center px-6">
          ...
          <Link href="/products">
            <button
              className="px-8 py-3 text-xs tracking-[0.2em] uppercase mt-4"
  ...
  return (
    <div style={{ background: '#f8f4ef', minHeight: '100vh' }}>
      {/* Breadcrumb */}
      <div
        className="pt-28 pb-6 px-6 lg:px-12"
        style={{ background: '#1c0f08', borderBottom: '1px solid rgba(201,168,76,0.15)' }}
      >
        <div className="max-w-7xl mx-auto flex items-center gap-3">
          <Link
            href="/"
            className="text-xs tracking-[0.15em] uppercase transition-colors hover:text-[#c9a84c]"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            <div
              ...
              style={{ aspectRatio: '1', background: '#ede5da' }}
            >
              ...
              {product.bestseller && (
                <div
                  className="absolute top-4 left-4 px-3 py-1.5 text-xs tracking-[0.15em] uppercase"
